  ...
  return (
    <div className="min-h-screen bg-base-950 text-base-100 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 pt-32">
            ...
            >
              <div className="text-center mb-6">
                ...
                <div className="text-6xl font-serif text-primary-400">
                  {isEmotional ? emotionalUserScore?.total : standardUserScore?.total}
                </div>
              </div>
        ...
        >
          <button onClick={() => { reset(); navigate('/topic') }} className="btn-primary flex items-center gap-2">
  ...
  return (
    <div>
      <div className="flex justify-between text-xs mb-1.5">
        ...
        <span className="text-base-200 font-mono">{score}/{max}</span>
      </div>
